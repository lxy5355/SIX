...
#########################################################################
par(mfrow=c(2,2))
hist(beta_ich_fun$x,breaks = 50, main="beta_ich_fun")
hist(beta_ks_fun$x,breaks = 50, main="beta_ks_fun")
hist(beta_ich_np$x,breaks = 50, main="beta_ich_np")
hist(beta_ks_np$x,breaks = 50, main="beta_ks_np")
