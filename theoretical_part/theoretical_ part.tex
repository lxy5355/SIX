...
E(Y|x) & = \sum_{y=0,1} yP(y|x) = 1 \times P(Y=1|x) + 0 \times P(Y=0|x) \\
 ...
 & = 1 - F(-(\alpha + x'\beta)) \equiv g(\alpha + x'\beta),
\end{split}
\]
