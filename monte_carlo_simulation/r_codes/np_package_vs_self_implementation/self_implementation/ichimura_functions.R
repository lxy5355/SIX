...
#define fourth-order Gaussian kernel function in accordance with KS functions
...
#define the objective minimizing function of sum-of-squared errors,which uses Gaussian kernel function.
