...
MSE_ich_fun <- mean((mc.beta.ich.fun - beta.true))^2
MSE_ks_fun <- mean((mc.beta.KS.fun - beta.true))^2

#save results of mc estimates
write.csv(mc.beta.ich.fun, 'mc_beta_ich_fun.csv')
write.csv(mc.beta.KS.fun, 'mc_beta_ks_fun.csv')