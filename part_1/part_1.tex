...
\begin{equation}
\mathcal{L}(\beta) = \frac{1}{n}\sum_{i=1}^n \left\{ (1 - Y_i)ln[ 1 - g(X_i'\beta)] + Y_iln[g(X_i'\beta)] \right\},
\end{equation}
...
\begin{equation}
\mathcal{L}_n(\beta) = \frac{1}{n}\sum_{i=1}^n \{ (1 - Y_i)ln[ 1 - \hat{G}_{-i}(X_i'\beta)] +  Y_iln[\hat{G}_{-i}(X_i'\beta)]\}\tau_{i},
\end{equation}
...
\begin{equation}
\frac{1}{n} \sum_{i=1}^n \frac{Y_i - \hat{G}_{-i}(X_i'\beta)}{\hat{G}_{-i}(X_i'\beta)(1 - \hat{G}_{-i}(X_i'\beta))} \frac{\partial\hat{G}_{-i}(X_i'\beta)}{\partial \beta} = 0
\end{equation} 
