...
Parametric methods for estimating $\beta$ require assumptions on the distribution of the error term $u$. It is commonly assumed $ u \sim N(0, \sigma^2)$. With further identification conditions such as $\sigma = 1$, $\beta_$ can be jointly identified ( see Madalla (1986)) and we can use maximum likelihood to estimate it.  Let $F_u(\cdot)$ denote the true CDF of $u$. Then we get: % Nevertheless, excluding the assumption of normality of the error term would in general lead to inconsistent estimates.
