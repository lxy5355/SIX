...
As with Ichimura's model, optimization of the maximum likelihood function might also become difficult. Apart from computational difficulties, optimization might lead to multiple local minima because the objective function might not be unimode or convex. \footnote{Zhou and Lang (1995) provide an alternative using an ``easy to compute'' semiparametric estimator.}
